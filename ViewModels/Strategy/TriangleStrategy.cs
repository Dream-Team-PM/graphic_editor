...
public class TriangleStrategy : IDrawingStrategy
{
    ...
    {
        // 1. Вычисляем текущий bounding box вершин треугольника
        ...
        // 4. Коэффициент масштабирования (берём максимум для сохранения пропорций)
        var scaleX = targetWidth / origWidth;
        var scaleY = targetHeight / origHeight;
        var scale = Math.Max(scaleX, scaleY);
        
        // 5. Центры: исходный и целевой
        ...
        // 6. Применяем трансформацию к каждой вершине
        foreach (var vertex in triangle.Vertices)
        {
            ...
            // 🔥 Явно уведомляем для реактивности
