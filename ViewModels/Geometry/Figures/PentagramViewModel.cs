...
public class PentagramViewModel : PolygonViewModel
{
    ...
    public PentagramViewModel(Point_1 center, double outerRadius,
    ...
    private static IEnumerable<Point_1> CreateVertices(Point_1 center, double R)
    {
    ...
    /// <summary>Пересчёт вершин пентаграммы по новому внешнему радиусу</summary>
    public void UpdateVertices(Point_1 center, double newOuterRadius)
    {
