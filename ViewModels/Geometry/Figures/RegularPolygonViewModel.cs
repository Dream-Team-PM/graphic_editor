...
public abstract class RegularPolygonViewModel : PolygonViewModel
{
    ...
    protected RegularPolygonViewModel(Point_1 center, int sides, double radius,
    ...
    private static IEnumerable<Point_1> CreateVertices(Point_1 center, int sides, double radius)
    {
